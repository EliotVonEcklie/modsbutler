...
import static moe.eliotvonecklie.modsbutler.ModsbutlerMod.LOGGER;
import static moe.eliotvonecklie.modsbutler.ModsbutlerMod.MODID;
...
public class ModSyncServer {
    ...
    private record RequestHandler(SocketChannel client, String request) implements Runnable {
        ...
        public void run() {
            ...
            String requestUrlString = requestFirstLine[1];
            URI requestUrl = new URI(requestUrlString);
            ...
            try {
                if (requestMethod.equals("GET")) {
                    ...
                    } else if (requestUrlString.contains("..")) {
